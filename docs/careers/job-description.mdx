...
With a vision of not just focusing on the company's success, we are also dedicated to the community. We are working to develop and grow the Prisma Korea community in partnership with the globally renowned tech company Prisma (https://www.prisma.io). In Korea, we actively operate the React Native Seoul community. We also discover and maintain numerous popular open-source libraries from abroad. All of these are conducted autonomously during work hours.
