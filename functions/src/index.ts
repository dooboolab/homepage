...
export const joinSlack = functions.https.onRequest((_: any, response: { redirect: (arg0: string) => void; }) => {
  response.redirect(
...
export const joinRNSeoul = functions.https.onRequest((_: any, response: { redirect: (arg0: string) => void; }) => {
  response.redirect(
...
export const joinGraphQLSeoul = functions.https.onRequest((_: any, response: { redirect: (arg0: string) => void; }) => {
  response.redirect(
